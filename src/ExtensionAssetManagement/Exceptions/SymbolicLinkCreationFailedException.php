...
class SymbolicLinkCreationFailedException extends ExtensionAssetManagementException
{
    public function __construct(string $name, string $message, int $code = 0, \Exception $previous = null)
    {
        parent::__construct("Faild to create sybmolic link for '{$name}'. Returned: {$message}", $code, $previous);
    }
}
